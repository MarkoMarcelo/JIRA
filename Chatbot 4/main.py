...
#import training
#training.training()
#antes de llmarlo necesita el entrenamiento

import chatbotOficial as co


#chatbot = Chat(db.pairs, reflections)#ya no se usa ya q tenemos nuevo chatbot
...
class Respuesta:
    def get_response(self, text):
        ...
        respuesta=chalo.responder(text)
        respuesta=db.clean(respuesta)
        if respuesta==None:
